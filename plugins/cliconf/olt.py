...
- Raylan (@jraylan)
name: huaweiolt
short_description: Use huaweiolt cliconf to run command on Huawei OLT platform
description:
- This plugin provides low level abstraction apis for sending and receiving
  CLI commands from Huawei OLTs.
version_added: 0.1.0
"""
    ...
    def get_device_info(self):
        if not self._device_info:
            device_info = {
                ...
                "network_os_hostname": "",
                "network_os_image": "",
                "network_os_platform": "Huawei Integrated Access Software",
                "network_os_type": "OLT"
            }
